...
@section('content')
    ...
    <form class="form_login_admin" method="post" action="{{route('execute_add_shop_category_product')}}" >
        ...
        <div class="mb-3" >
            ...
            <input type="text" class="" style="width: 305px;" id="formGroupExampleInput" autofocus required minlength="3" maxlength="20" placeholder="Имя новой категории" name="name">
        </div>
